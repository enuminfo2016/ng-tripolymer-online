...
@Component({
    selector: 'app-shop-right-sidebar-page',
    templateUrl: './shop-right-sidebar-page.component.html',
    styleUrls: ['./shop-right-sidebar-page.component.scss']
})
export class ShopRightSidebarPageComponent implements OnInit {
