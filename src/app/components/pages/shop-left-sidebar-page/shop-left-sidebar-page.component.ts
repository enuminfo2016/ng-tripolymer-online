...
@Component({
    selector: 'app-shop-left-sidebar-page',
    templateUrl: './shop-left-sidebar-page.component.html',
    styleUrls: ['./shop-left-sidebar-page.component.scss']
})
export class ShopLeftSidebarPageComponent implements OnInit {
